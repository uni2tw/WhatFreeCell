...
namespace FreeCellSolitaire.UI
{
    public class FoundationsContainer : GeneralContainer
    {
        ...
        public void SetControls()
        {
            ...
            {
                var panel = new FoundationColumnPanel(i, _cardWidth, _cardHeight, _cardBorderWidth, $"f{i}", this);
    ...
    {
        public FoundationColumnPanel(int index, int cardWidth, int cardHeight, int cardBorderWidth, string code, GeneralContainer owner)
